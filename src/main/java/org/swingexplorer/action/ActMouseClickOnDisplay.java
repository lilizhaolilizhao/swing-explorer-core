 ...
 *   
 */
package org.swingexplorer.action;
...
import org.swingexplorer.DisplayableException;
import org.swingexplorer.MdlSwingExplorer;
import org.swingexplorer.PNLGuiDisplay;
...
public class ActMouseClickOnDisplay extends MouseAdapter {
	...
	public ActMouseClickOnDisplay(PNLGuiDisplay displayP, MdlSwingExplorer modelP) {
		display = displayP;
		model = modelP;
	}
